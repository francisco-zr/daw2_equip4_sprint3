  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse p-0" id="navbarNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link <?php if (basename($_SERVER['SCRIPT_NAME']) == 'LlistatPresupost.php') echo 'active'; ?>" href="../../public/LlistatPresupost.php"><i class="fa-solid fa-clipboard-question"></i>Presupuestos</a></li>
