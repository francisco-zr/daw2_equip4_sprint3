...
INSERT INTO `budgets` (`id_budget`, `price`, `accepted`, `hidden`, `status`) VALUES ('7', '300', NULL, NULL, 'Done');
...
INSERT INTO `users` (`id_user`, `dni`, `name_user`, `last_name`, `phone_number`, `email`, `emblems`, `nick_name`, `password`, `hidden`, `id_company`, `profile_image`, `type_user`, `token`) VALUES ('4', '00330123L', 'Julen', 'Martinez', '678532513', 'julenmartinez@iesmontsia.org', NULL, 'Julen', NULL, NULL, '3', NULL, 'client', NULL);
...
INSERT INTO `users` (`id_user`, `dni`, `name_user`, `last_name`, `phone_number`, `email`, `emblems`, `nick_name`, `password`, `hidden`, `id_company`, `profile_image`, `type_user`, `token`) VALUES ('8', '00123423P', 'Paola', 'López ', '67893234', 'paolalopez@gmail.com', NULL, 'Paola23', NULL, NULL, '2', NULL, 'admin', NULL);

INSERT INTO `users` (`id_user`, `dni`, `name_user`, `last_name`, `phone_number`, `email`, `emblems`, `nick_name`, `password`, `hidden`, `id_company`, `profile_image`, `type_user`, `token`) VALUES ('9', '00220431L', 'Pepito', 'Villarroya', '61234567', 'pepitov@iesmontsia.org', NULL, 'Pepito8', NULL, '3', NULL, NULL, 'worker', NULL);
...
INSERT INTO `companies` (`id_companydefineix`, `name_company`, `email`, `phone_number`, `cif`, `hidden`) VALUES ('6', 'Company 6', 'company6@gmail.com', '655333222', 'IDGFUSJKY', NULL);
...
INSERT INTO `tasks` (`id_task`, `accepted`, `state`, `start_date`, `final_date`, `price`, `manages`, `id_user`, `id_questionary`, `id_recommendation`, `id_budget`, `id_impact`, `percentage`, `hidden`) VALUES ('7', '1', NULL, '2022-06-12 00:00:00', '2022-06-20 00:00:00', '100', NULL, '3', '1', '1', '2', '2', '50', NULL);

INSERT INTO `tasks` (`id_task`, `accepted`, `state`, `start_date`, `final_date`, `price`, `manages`, `id_user`, `id_questionary`, `id_recommendation`, `id_budget`, `id_impact`, `percentage`, `hidden`) VALUES ('8', '1', NULL, '2022-07-12 00:00:00', '2022-07-20 00:00:00', '100', NULL, '4', '1', '1', '1', '2', '50', NULL);

INSERT INTO `tasks` (`id_task`, `accepted`, `state`, `start_date`, `final_date`, `price`, `manages`, `id_user`, `id_questionary`, `id_recommendation`, `id_budget`, `id_impact`, `percentage`, `hidden`) VALUES ('9', '1', NULL, '2022-08-12 00:00:00', '2022-08-20 00:00:00', '100', NULL, '5', '1', '1', '3', '3', '100', NULL);

INSERT INTO `tasks` (`id_task`, `accepted`, `state`, `start_date`, `final_date`, `price`, `manages`, `id_user`, `id_questionary`, `id_recommendation`, `id_budget`, `id_impact`, `percentage`, `hidden`) VALUES ('10', '1', NULL, '2022-09-12 00:00:00', '2022-09-20 00:00:00', '100', NULL, '6', '1', '1', '2', '3', '100', NULL);

INSERT INTO `tasks` (`id_task`, `accepted`, `state`, `start_date`, `final_date`, `price`, `manages`, `id_user`, `id_questionary`, `id_recommendation`, `id_budget`, `id_impact`, `percentage`, `hidden`) VALUES ('11', '1', NULL, '2022-10-12 00:00:00', '2022-10-20 00:00:00', '100', NULL, '7', '1', '1', '2', '6', '100', NULL);
