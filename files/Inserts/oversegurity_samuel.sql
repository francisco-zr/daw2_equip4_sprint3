...
--
-- Servidor: db
-- Tiempo de generación: 10-01-2023 a las 19:55:01
...
(2, 'Respuesta 2', 'Descripción de la respuesta 2', NULL, 1),
(3, 'Respuesta 3', 'Descripción de la respuesta 3', NULL, 2),
(4, 'Respuesta 4', 'Descripción de la respuesta 4', NULL, 2),
(5, 'Respuesta 5', 'Descripción de la respuesta 5', NULL, 3),
(6, 'Respuesta 6', 'Descripción de la respuesta 6', NULL, 3),
(7, 'Respuesta 7', 'Descripción de la respuesta 7', NULL, 4),
(8, 'Respuesta 8', 'Descripción de la respuesta 8', NULL, 4),
(9, 'Respuesta 9', 'Descripción de la respuesta 9', NULL, 5),
(10, 'Respuesta 10', 'Descripción de la respuesta 10', NULL, 5),
(11, 'Respuesta 11', 'Descripción de la respuesta 11', NULL, 6),
(12, 'Respuesta 12', 'Descripción de la respuesta 12', NULL, 6);
...
(18, 0, NULL, NULL, 'Pending'),
(19, 0, NULL, NULL, 'Pending'),
(20, 0, NULL, NULL, 'Pending'),
(21, 0, NULL, NULL, 'Pending'),
(22, 0, NULL, NULL, 'Pending'),
(23, 0, NULL, NULL, 'Pending'),
(24, 0, NULL, NULL, 'Pending'),
(25, 0, NULL, NULL, 'Pending'),
(26, 0, NULL, NULL, 'Pending'),
(27, 0, NULL, NULL, 'Pending'),
(28, 0, NULL, NULL, 'Pending'),
(29, 0, NULL, NULL, 'Pending'),
(30, 0, NULL, NULL, 'Pending'),
(31, 0, NULL, NULL, 'Pending'),
(32, 0, NULL, NULL, 'Pending'),
(33, 0, NULL, NULL, 'Pending'),
(34, 0, NULL, NULL, 'Pending'),
(35, 0, NULL, NULL, 'Pending'),
(36, 0, NULL, NULL, 'Pending'),
(37, 0, NULL, NULL, 'Pending'),
(38, 0, NULL, NULL, 'Pending'),
(40, 0, NULL, NULL, 'Pending'),
(41, 0, NULL, NULL, 'Pending');
...
(2, '¿Pregunta 2?', 'Descripción de la pregunta 2', NULL, 1),
(3, '¿Pregunta 3?', 'Descripción de la pregunta 3', NULL, 1),
(4, '¿Pregunta 4?', 'Descripción de la pregunta 4', NULL, 1),
(5, '¿Pregunta 5?', 'Descripción de la pregunta 5', NULL, 1),
(6, '¿Pregunta 6?', 'Descripción de la pregunta 6', NULL, 1);
...
(2, 'Recomendación 2', 'Descripción de la recomendación 2', NULL, 2),
(3, 'Recomendación 3', 'Descripción de la recomendación 3', NULL, 3),
(4, 'Recomendación 4', 'Descripción de la recomendación 4', NULL, 4),
(5, 'Recomendación 5', 'Descripción de la recomendación 5', NULL, 5),
(6, 'Recomendación 6', 'Descripción de la recomendación 6', NULL, 6),
(7, 'Recomendación 7', 'Descripción de la recomendación 7', NULL, 7),
(8, 'Recomendación 8', 'Descripción de la recomendación 8', NULL, 8),
(9, 'Recomendación 9', 'Descripción de la recomendación 9', NULL, 9),
(10, 'Recomendación 10', 'Descripción de la recomendación 10', NULL, 10),
(11, 'Recomendación 11', 'Descripción de la recomendación 11', NULL, 11),
(12, 'Recomendación 12', 'Descripción de la recomendación 12', NULL, 12);
...
INSERT INTO `tasks` (`id_task`, `accepted`, `state`, `price`, `start_date`, `final_date`, `id_user`, `id_questionary`, `id_recommendation`, `id_budget`, `percentage`, `importance`, `hidden`) VALUES
(1, 1, 'ToDo', NULL, '2022-05-12 00:00:00', '2022-05-13 00:00:00', 1, 1, 1, 0, 0, 'warning', NULL),
(2, 1, 'ToDo', NULL, '2022-05-13 00:00:00', '2022-05-14 00:00:00', 1, 1, 1, 0, 0, 'danger', NULL),
(3, 1, 'InProgress', NULL, '2022-05-14 00:00:00', '2022-05-17 00:00:00', 1, 1, 1, 0, 50, 'success', NULL),
(4, 1, 'InProgress', NULL, '2022-05-17 00:00:00', '2022-05-22 00:00:00', 1, 1, 1, 0, 50, 'danger', NULL),
(5, 1, 'InProgress', NULL, '2022-05-19 00:00:00', '2022-05-24 00:00:00', 1, 1, 1, 0, 50, 'warning', NULL),
(6, 1, 'Done', NULL, '2022-05-12 00:00:00', '2022-05-20 00:00:00', 1, 1, 1, 0, 100, 'danger', NULL);
...
--
ALTER TABLE `budgets`
  MODIFY `id_budget` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `resources_url`
  ADD CONSTRAINT `resources_url_ibfk_1` FOREIGN KEY (`id_course`) REFERENCES `courses` (`id_course`);
