...
--
-- Servidor: db
-- Tiempo de generación: 12-01-2023 a las 18:33:22
...
--
ALTER TABLE `questionnaries`
  MODIFY `id_questionary` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tasks`
  MODIFY `id_task` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
