...
--
-- Servidor: db
-- Tiempo de generación: 12-01-2023 a las 20:02:27
...
(3, 0, NULL, NULL, 'Pending'),
(4, 0, NULL, NULL, 'Pending'),
(5, 0, NULL, NULL, 'Pending'),
(6, 0, NULL, NULL, 'Pending'),
(7, 0, NULL, NULL, 'Pending'),
(8, 0, NULL, NULL, 'Pending'),
(9, 0, NULL, NULL, 'Pending');
...
(2, 'Cuestionario 2', NULL, NULL, NULL);
...
INSERT INTO `reports` (`id_report`, `id_user`, `name_report`, `date_report`, `hidden`) VALUES
(1, 1, 'Cuestionari contestat 1', '2022-11-16', NULL),
(2, 1, 'Cuestionari contestat 2', '2022-11-16', NULL);
...
INSERT INTO `results` (`id_result`, `hidden`, `id_answer`, `id_report`) VALUES
(1, NULL, 1, 1),
(2, NULL, 3, 1),
(3, NULL, 6, 1),
(4, NULL, 7, 1),
...
--
ALTER TABLE `questionnaries`
  MODIFY `id_questionary` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `questionnary_user`
  MODIFY `id_questionnary_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
